...
Create a list of subtasks based on the [TASK] provided. Your FIRST THOUGHT should be, do I need to call a tool here to answer
or fulfill the user's request. First, think through the necessary steps of the plan. Make sure to carefully look over the tools you are given access to to decide this.
